            ...
            <div class="row pt-5">
                <div class="col-md-8 col-xl-6 text-center text-md-start mx-auto">
                    <div class="text-center">
                        <p class="fw-bold text-success mb-2" style="font-size: 1.6rem;"><strong>JC Happy Jump Party Rental</strong></p>
                        <h2 class="fw-bold" > Ofrecemos excelentes alquileres a excelentes precios y estamos a su servicio.</h2>
                    </div>
                </div>
                    ...
                    <div class="col mb-5">
                        <div class="card shadow-sm">
                            <div class="card-body px-4 py-5 px-md-5">
                                ...
                                <h5 class="fw-bold card-title">Alquiler de Mesas</h5>
                                <p class="text-muted card-text mb-4">Nuestras mesas vienen en una variedad de tamaños y formas. Tenemos mesas redondas, mesas cuadradas, serpentina y mucho más. Nuestro inventario de alquiler de mesas y sillas para fiestas es único.</p><button class="btn btn-primary shadow" type="button">Learn more</button>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-4">
                        <div class="card shadow-sm">
                            <div class="card-body px-4 py-5 px-md-5">
                                ...
                                <h5 class="fw-bold card-title">Alquiler de Carpas</h5>
                                <p class="text-muted card-text mb-4"> Bibendum vulputate cras aenean.</p><button class="btn btn-primary shadow" type="button">Learn more</button>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-4">
                        <div class="card shadow-sm">
                            <div class="card-body px-4 py-5 px-md-5">
                                ...
                                <h5 class="fw-bold card-title">Alquiler de Calentones</h5>
                                <p class="text-muted card-text mb-4">Bibendum vulputate cras aenean.</p><button class="btn btn-primary shadow" type="button">Learn more</button>
                            </div>
                        </div>
                    </div>
